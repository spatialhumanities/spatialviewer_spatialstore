...
public class Config {
    ...
    public static Response getResult(File file, String name) {
        return Response.ok((Object) file).header("Content-disposition", "attachment;filename=" + name).header("Access-Control-Allow-Origin", "*").build();
    }
